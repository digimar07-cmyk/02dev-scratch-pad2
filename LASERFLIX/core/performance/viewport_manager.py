...
class ViewportManager:
    ...
    def __init__(
        ...
        """
        Args:
            canvas: Canvas com scroll (tk.Canvas injetado pelo caller em ui/)
            scrollable_frame: Frame interno do canvas (tk.Frame injetado pelo caller)
        ...
        # Estado
        self.all_items: List = []
        self.card_builder_fn: Any = None
        self.rendered_indices: set = set()
    ...
    def set_items(
        ...
        card_builder_fn: Callable[[Any, str, dict, int, int], Any]
    ):
        """
    ...
    def render_visible_range(self) -> None:
        ...
        card_height = 420  # 410px altura + 10px gap
