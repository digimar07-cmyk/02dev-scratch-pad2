...
UX-REFACTOR: SelectionBarManager integrado
- Selection bar auto show/hide
- Gerenciado por SelectionBarManager (não main_window)
"""
...
class UIBuilder:
    ...
    def _build_header(window) -> None:
        ...
        window.header = HeaderBar(window.root, {
            ...
            # UX-REFACTOR: Removido on_toggle_select (sem botão de seleção)
    ...
    def _build_main_container(window) -> None:
        ...
        # UX-REFACTOR: Instanciar SelectionBarManager
        # Precisa ser DEPOIS de selection_ctrl e display_ctrl existirem
        # Será inicializado no main_window.__init__ após controllers
        window._content_frame = content_frame  # Guardar referência para SelectionBarManager
