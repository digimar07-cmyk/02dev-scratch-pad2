"""
ui/managers/modal_manager.py — Gerencia todos os modals/dialogs da aplicação.

FASE 7F.1: Centraliza gerenciamento de dialogs
Redução estimada: -35 linhas no main_window.py

📦 MOVIDO de ui/controllers/ para ui/managers/ em 09/03/2026
   Motivo: ModalManager é um Manager, não um Controller MVC.
   Controllers coordenam fluxo de dados entre UI e Core.
   Managers gerenciam recursos e serviços de suporte.
"""
import tkinter as tk
from tkinter import messagebox, simpledialog
from ui.collections_dialog import CollectionDialog
from ui.prepare_folders_dialog import PrepareFoldersDialog
from ui.import_mode_dialog import ImportDialog
...
class ModalManager:
    ...
    Padrão: Facade — simplifica interface para subsistema de dialogs.
    """
    ...
    def confirm(self, title, message):
        """Mostra dialog de confirmação. Retorna True/False."""
